...
export interface IEventsClient {
    ...
    create(command: CreateEventCommand): Observable<number>;
    update(id: number, command: UpdateEventCommand): Observable<FileResponse>;
    delete(id: number): Observable<FileResponse>;
}
...
export class EventDto implements IEventDto {
    id?: number;
    name?: string | undefined;
    locationStart?: string | undefined;
    locationEnd?: string | undefined;
    timeStart?: Date;
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.name = _data["name"];
            this.locationStart = _data["locationStart"];
            this.locationEnd = _data["locationEnd"];
            ...
            if (Array.isArray(_data["attendees"])) {
                ...
                for (let item of _data["attendees"])
                    this.attendees!.push(AttendeeDto.fromJS(item));
            }
...
export class AttendeeDto implements IAttendeeDto {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.client = _data["client"] ? ContactDto.fromJS(_data["client"]) : <any>undefined;
            this.guests = _data["guests"];
